...
public abstract class BaseEvent {
     ...
     */
    public void cancel() {
        if (!com.arc_studio.brick_lib.api.event.ICancelableEvent.class.isAssignableFrom(this.getClass())) {
    ...
    public Result getResult() {
        if (!com.arc_studio.brick_lib.api.event.IResultEvent.class.isAssignableFrom(this.getClass())) {
