...
public class ForgePlatform {
    ...
    NetworkRegistry.newSimpleChannel(
            new ResourceLocation(BrickLib.MOD_ID, "c2s_play"),
            () -> PROTOCOL_VERSION,
            PROTOCOL_VERSION::equals,
            PROTOCOL_VERSION::equals
    );
    //?} else {
    /*ChannelBuilder.named(BrickLib.createBrickRL("c2s_play"))
            .optional()
    ...
    *///?}
    ...
    public static final SimpleChannel c2sLoginChannel = //? if < 1.20.4 {
            NetworkRegistry.newSimpleChannel(
                    new ResourceLocation(BrickLib.MOD_ID, "c2s_login"),
                    () -> PROTOCOL_VERSION,
                    PROTOCOL_VERSION::equals,
                    PROTOCOL_VERSION::equals
            );
    //?} else {
    /*ChannelBuilder.named(BrickLib.createBrickRL("c2s_login"))
            .optional()
            .networkProtocolVersion(1)
            .serverAcceptedVersions(Channel.VersionTest.exact(1))
            .clientAcceptedVersions(Channel.VersionTest.exact(1))
    ...
    *///?}
    ...
    NetworkRegistry.newSimpleChannel(
            new ResourceLocation(BrickLib.MOD_ID, "s2c_play"),
            () -> PROTOCOL_VERSION,
            PROTOCOL_VERSION::equals,
            PROTOCOL_VERSION::equals
    );
    //?} else {
            /*ChannelBuilder.named(BrickLib.createBrickRL("s2c_play"))
                    .optional()
                    .networkProtocolVersion(1)
                    .serverAcceptedVersions(Channel.VersionTest.exact(1))
                    .clientAcceptedVersions(Channel.VersionTest.exact(1))
    ...
    *///?}
    ...
    public static final SimpleChannel s2cLoginChannel = //? if <1.20.4 {
            NetworkRegistry.newSimpleChannel(
                    new ResourceLocation(BrickLib.MOD_ID, "s2c_login"),
                    () -> PROTOCOL_VERSION,
                    PROTOCOL_VERSION::equals,
                    PROTOCOL_VERSION::equals
            );
    //?} else {
            /*ChannelBuilder.named(BrickLib.createBrickRL("s2c_login"))
                    .optional()
                    .networkProtocolVersion(1)
                    .serverAcceptedVersions(Channel.VersionTest.exact(1))
                    .clientAcceptedVersions(Channel.VersionTest.exact(1))
