...
public class Codecs {
    public static class Basic {
        ...
        public static final Codec<Float> POSITIVE_FLOAT = floatRangeMinExclusiveWithMessage(
                0.0F, Float.MAX_VALUE, float_ -> "Value must be positive: " + float_
        );
        ...
        public static PrimitiveCodec<Boolean> BOOL = new PrimitiveCodec<Boolean>() {
            @Override
        ...
        public static PrimitiveCodec<Byte> BYTE = new PrimitiveCodec<Byte>() {
            @Override
        ...
        public static PrimitiveCodec<Short> SHORT = new PrimitiveCodec<Short>() {
            @Override
        ...
        public static PrimitiveCodec<Integer> INT = new PrimitiveCodec<Integer>() {
            @Override
        ...
        public static PrimitiveCodec<Long> LONG = new PrimitiveCodec<Long>() {
            @Override
        ...
        public static PrimitiveCodec<Float> FLOAT = new PrimitiveCodec<Float>() {
            @Override
        ...
        public static PrimitiveCodec<Double> DOUBLE = new PrimitiveCodec<Double>() {
            @Override
        ...
        public static PrimitiveCodec<String> STRING = new PrimitiveCodec<String>() {
            @Override
        ...
        public static PrimitiveCodec<ByteBuffer> BYTE_BUFFER = new PrimitiveCodec<ByteBuffer>() {
            @Override
        ...
        public static PrimitiveCodec<IntStream> INT_STREAM = new PrimitiveCodec<IntStream>() {
            @Override
        ...
        public static PrimitiveCodec<LongStream> LONG_STREAM = new PrimitiveCodec<LongStream>() {
            @Override
        ...
        public static Codec<Dynamic<?>> PASSTHROUGH = new Codec<Dynamic<?>>() {
            @Override
    ...
    public static final Codec<JsonElement> JSON = Codec.PASSTHROUGH
            .xmap(
                    dynamic -> dynamic.convert(JsonOps.INSTANCE).getValue(), /* method_46387 */ jsonElement -> new Dynamic<>(JsonOps.INSTANCE, jsonElement)
            );
    ...
    public static final Codec<Vector3f> VECTOR3F = Codec.FLOAT
            ...
            .comapFlatMap(
                    list -> Util.fixedSize(list, 3)
                            .map(listx -> new Vector3f(listx.get(0), listx.get(1), listx.get(2))),
    ...
    public static final Codec<Quaternionf> QUATERNIONF_COMPONENTS = Codec.FLOAT
            ...
            .comapFlatMap(
                    list -> Util.fixedSize(list, 4)
                            .map(floats -> new Quaternionf(floats.get(0), floats.get(1), floats.get(2), floats.get(3))),
    ...
    public static final Codec<Quaternionf> QUATERNIONF = Codec.either(QUATERNIONF_COMPONENTS, AXIS_ANGLE_4F.xmap(Quaternionf::new, AxisAngle4f::new))
    ...
    public static Codec<Matrix4f> MATRIX4F = Codec.FLOAT
            .listOf()
            .comapFlatMap(list -> Util.fixedSize(list, 16).map(listx -> {
    ...
    public static final Codec<Codecs.TagOrElementLocation> TAG_OR_ELEMENT_ID = Codec.STRING
            .comapFlatMap(
                    string -> string.startsWith("#")
                            ? ResourceLocation.read(string.substring(1))
                            .map( resourceLocation -> new Codecs.TagOrElementLocation(resourceLocation, true))
                            : ResourceLocation.read(string).map( resourceLocation -> new Codecs.TagOrElementLocation(resourceLocation, false)),
                    Codecs.TagOrElementLocation::decoratedId
            );
    private static final Function<Optional<Long>, OptionalLong> toOptionalLong = optional -> optional.map(OptionalLong::of)
            .orElseGet(OptionalLong::empty);
    private static final Function<OptionalLong, Optional<Long>> fromOptionalLong = optionalLong -> optionalLong.isPresent()
    ...
    public static final Codec<GameProfile> GAME_PROFILE = RecordCodecBuilder.create(
            instance -> instance.group(
                            Codec.mapPair(
                                    ...
                                    .flatXmap(Codecs::mapIdNameToGameProfile, Codecs::mapGameProfileToIdName)
    ...
    public static <F, S> Codec<Either<F, S>> xor(Codec<F> first, Codec<S> second) {
        return new Codecs.XorCodec<>(first, second);
    }
    ...
    public static <P, R> Codec<R> intervalCodec(
        ...
        Codec<R> general = new Codecs.EitherCodec<>(listType, objectType)
    ...
    public static <E> Codec<E> overrideLifecycle(Codec<E> codec, Function<E, Lifecycle> function, Function<E, Lifecycle> function2) {
        return codec.mapResult(
                new Codec.ResultFunction<>() /* Codecs$3 */ {
                    @Override
    ...
    public static <A> Codec<A> lazyInitializedCodec(Supplier<Codec<A>> delegate) {
        return new Codecs.LazyInitializedCodec<>(delegate);
    }
    ...
    public static <A> Codec<A> catchDecoderException(Codec<A> codec) {
        return Codec.of(codec, new Decoder<>() /* Codecs$4 */ {
            @Override
    ...
    static final class EitherCodec<F, S> implements Codec<Either<F, S>> {
        ...
        public boolean equals(Object object) {
            if (this == object) {
                ...
                Codecs.EitherCodec<?, ?> eitherCodec = (Codecs.EitherCodec<?, ?>)object;
    ...
    static final class XorCodec<F, S> implements Codec<Either<F, S>> {
        ...
        public boolean equals(Object object) {
            if (this == object) {
                ...
                Codecs.XorCodec<?, ?> xorCodec = (Codecs.XorCodec<?, ?>)object;
