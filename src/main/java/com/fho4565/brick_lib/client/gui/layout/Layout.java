...
public abstract class Layout {
    ...
    public abstract void placeComponents(IBrickComponent...widgets);
    public void placeComponents(Collection<IBrickComponent> widgets){
        this.placeComponents(widgets.toArray(new IBrickComponent[0]));
    }
