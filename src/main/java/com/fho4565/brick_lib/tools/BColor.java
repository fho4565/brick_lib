package com.fho4565.brick_lib.tools;
...
public class BColor {
    ...
    public static class GradientColor{
        ...
        public static class Builder {
            ...
            public GradientColor end(Color color){
                this.gradientColor.end = color;
                return this.gradientColor;
            }
            public GradientColor end(int color){
                this.gradientColor.end = new Color(color,true);
                return this.gradientColor;
            }
